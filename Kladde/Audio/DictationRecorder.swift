...
final class DictationRecorder {
    ...
    /// The levels measured so far, oldest first, for the live waveform to
    /// draw. Capped at more bars than the card can ever show, which at one
    /// sample per metering tick is the last few seconds of the recording.
    private(set) var levels: [Float] = []

    private static let levelHistory = 240
