...
/// Owns the app-level window lifecycle that makes Longhand feel like a classic
...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    /// Longhand owns its window/tab behaviour Safari-and-Finder style instead of
    ...
    /// Keeps Longhand running when its last window closes, instead of quitting.
